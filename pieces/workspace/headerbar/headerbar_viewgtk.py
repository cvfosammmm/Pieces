...
class HeaderBarRight(Gtk.HeaderBar):
    ...
    def insert_workspace_menu(self):
        ...
        self.pmb.add_action_button(box, _('Rename project...'), 'win.rename-project', keyboard_shortcut='F2')
        self.pmb.add_action_button(box, _('Delete project...'), 'win.delete-project')
